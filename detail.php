    ...
    <div class="main">
      ...
      <div class="main-content">
		...
		<!--Map Begin-->
		 <div>  
<MAP NAME=mymap>
<area shape="rect" alt="Detail Gigi 1" title="Detail Gigi 1" coords="45,15,204,44" href="" target="" />
<area shape="rect" alt="Detail Gigi 2" title="Detail Gigi 2" coords="46,47,206,201" href="" target="" />
<area shape="rect" alt="Detail Gigi 3" title="Detail Gigi 3" coords="206,48,235,202" href="" target="" />
<area shape="rect" alt="Detail Gigi 4" title="Detail Gigi 4" coords="45,203,204,231" href="" target="" />
<area shape="rect" alt="Detail Gigi 5" title="Detail Gigi 5" coords="13,46,44,201" href="" target="" />
</MAP>
<IMG SRC="images/gigi-1.jpg" ALT="Site map" USEMAP="#mymap" WIDTH=250 HEIGHT=250>
<div class="clear"></div>
<input id="submit" class="button" type="submit" tabindex="6" value="Publish" name="submit">
<input class="button" type="reset" tabindex="6" value="reset" name="reset">
</div>
<div class="clear"></div>
<h2>Keterangan Odontogram</h2>
<table style="width:650px;height:70px;">
<tr>
<th class="top" scope="col">Belum Erupsi</th>
				<th class="top" scope="col">Sudah Dicabut</th>
				<th class="top" scope="col">Goyah</th>
				<th class="top" scope="col">Tinggal Akar</th>
				<th class="top" scope="col">Karies</th>
				<th class="top" scope="col">Tumpatan</th>
				</tr>
<tr>
<td>
